...
export default function Heros() {
  return (
    <>
     <div className="relative bg-linear-to-b from-black to-[#32220d] overflow-hidden min-h-[90vh] flex items-center justify-center">
      {/* Orange glow effects */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-orange opacity-10 rounded-full blur-[100px]"></div>
      ...
      <div className="section-container relative z-10 text-center">
        <div className="flex flex-col items-center justify-center max-w-4xl mx-auto">
          <div className="animate-fade-in">
            <span className="inline-block bg-orange/10 text-orange px-4 py-2 rounded-full text-sm font-medium mb-6 border border-orange/20">
              Introducing Dukan.
            </span>
            
            <h1 className="text-4xl text-gray-300 md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight">
              Transform Your Business With Our <span className="bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">DUKAN</span>
            </h1>
            
            <p className="text-lg md:text-xl mb-8 text-gray-300 max-w-2xl mx-auto">
              Streamline your operations, boost productivity, and enhance customer satisfaction with our cutting-edge Dukan platform. Experience seamless integration and unparalleled support.
            </p>
            
            {/* <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Butt className="bg-saas-orange hover:bg-orange-600 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200">
                Get Started Free
